...
const SalesOrderSchema = new Schema(
  {
    ...
    // RF-11: Vinculación a customer y vehículo existentes
    customer: {
      type: Schema.Types.ObjectId,
      ref: "Customer",
      required: [true, "El customer es obligatorio"],
    },
...
SalesOrderSchema.index({ customer: 1, fecha: -1 }); // Órdenes por customer ordenadas por fecha
SalesOrderSchema.index({ customer: 1, estado: 1 }); // Filtrar por customer y estado
SalesOrderSchema.index({ customer: 1, eliminado: 1 }); // Excluir eliminados por customer
